...
Array.prototype.even = function(){
    let newArr = this.filter(el => el % 1 == 0 && typeof el === 'number').filter(el => el % 2 === 0)
    return newArr
}

Array.prototype.odd = function(){
    let newArr = this.filter(el => el % 1 == 0 && typeof el === 'number').filter(el => el % 2)
    return newArr
}

Array.prototype.under = function(x){
    let newArr = this.filter(el => el % 1 == 0 && typeof el === 'number').filter(el => el < x)
    return newArr
}
...
Array.prototype.inRange = function(min,max){
    let newArr = this.filter(el => el % 1 == 0 && typeof el === 'number').filter(el => el >= min && el <= max)
    return newArr
}
